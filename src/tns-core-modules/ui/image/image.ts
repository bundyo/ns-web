...
import NSImage from "../../../hypers/ns-image";

export * from "./image-common";

export class Image extends ImageBase {
    nativeViewProtected: NSImage;
    private _imageSourceAffectsLayout: boolean = true;
    private _templateImageWasCreated: boolean;

    public createNativeView() {
        return document.createElement("ns-image");
    ...
    private setTintColor(value: Color) {
        //this.nativeViewProtected.style.filter = ``;
    ...
    // public _setNativeImage(nativeImage) {
    ...
    [srcProperty.setNative](value: any) {
        this.nativeViewProtected.src = value;
    }
}
